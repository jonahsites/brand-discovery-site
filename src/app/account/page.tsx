  ...
  return (
    <Page className="pt-6 md:pt-9">
      <div className="mb-6 md:mb-[34px] flex items-center gap-4 md:gap-[22px]">
        <div className="grid h-[66px] w-[66px] md:h-[104px] md:w-[104px] flex-none place-items-center rounded-[12px] md:rounded-lg bg-sky text-[20px] md:text-[30px] font-extrabold tracking-[-.04em]">JR</div>
