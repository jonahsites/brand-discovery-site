    ...
    <Page className="pt-6 md:pt-[34px]">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_400px] items-start">
        <div>
          ...
          <div className="mb-6 flex gap-[10px]"><Button className="flex-1" size="lg" onClick={pay}> Pay</Button><Button className="flex-1" size="lg" variant="secondary" onClick={pay}>Google Pay</Button><Button className="hidden sm:flex flex-1" size="lg" variant="secondary" onClick={pay}>Shop Pay</Button></div>
