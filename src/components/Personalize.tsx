...
export const OPEN_PATHS = ["/login", "/signup", "/r/", "/design-system", "/verify-email", "/forgot-password", "/reset-password", "/about", "/contact", "/privacy", "/terms", "/shipping-and-returns", "/demo-brand"];
