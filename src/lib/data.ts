...
export const BRANDS: Brand[] = [
  { slug: "form-and-void", cover: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=1200&q=70&auto=format&fit=crop", name: "Form & Void", init: "FV", city: "Rotterdam", country: "NL", tagline: "Workwear cut from one bolt at a time", items: 22, followers: 1847, verified: true, tint: "#DBE1EF", ink: "#1A1A1A",
  ...
  { slug: "studio-arva", cover: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=1200&q=70&auto=format&fit=crop", name: "Studio Arva", init: "SA", city: "Lisbon", country: "PT", tagline: "Heavyweight cotton, no seasons", items: 14, followers: 892, verified: true, tint: "#C7DCEF", ink: "#1A1A1A",
  ...
  { slug: "onda-studio", cover: "https://images.unsplash.com/photo-1554568218-0f1715e72254?w=1200&q=70&auto=format&fit=crop", name: "Onda Studio", init: "OS", city: "Porto", country: "PT", tagline: "Salt-washed, cut once", items: 31, followers: 4200, verified: true, tint: "#1C3247", ink: "#F6F7F9",
  ...
  { slug: "core-theory", cover: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=1200&q=70&auto=format&fit=crop", name: "Core Theory", init: "CT", city: "Kyoto", country: "JP", tagline: "Knitwear for long winters", items: 9, followers: 340, verified: false, tint: "#456F94", ink: "#fff",
  ...
  { slug: "neutral-ground", cover: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=1200&q=70&auto=format&fit=crop", name: "Neutral Ground", init: "NG", city: "Copenhagen", country: "DK", tagline: "Quiet shirting", items: 18, followers: 2400, verified: true, tint: "#456F94", ink: "#fff",
  ...
  { slug: "nomad", cover: "https://images.unsplash.com/photo-1571945153237-4929e783af4a?w=1200&q=70&auto=format&fit=crop", name: "Nomad", init: "NO", city: "Melbourne", country: "AU", tagline: "Ripstop for the road", items: 26, followers: 1120, verified: false, tint: "#EDF1F4", ink: "#1A1A1A",
...
export const PRODUCTS: Product[] = [
  { slug: "panel-work-jacket", image: "https://images.unsplash.com/photo-1611312449408-fcece27cdbb7?w=900&q=75&auto=format&fit=crop", brand: "form-and-void", name: "Panel Work Jacket", price: 248, compareAt: 310, tag: "20% off", tagBg: "#DBE1EF", tagFg: "#1A1A1A", category: "Outerwear" },
  { slug: "heavyweight-crew", image: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=900&q=75&auto=format&fit=crop", brand: "studio-arva", name: "Heavyweight Crew", price: 126, tag: "New", tagBg: "#121212", tagFg: "#fff", category: "Knitwear" },
  ...
  { slug: "merino-half-zip", image: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=900&q=75&auto=format&fit=crop", brand: "core-theory", name: "Merino Half-Zip", price: 164, tag: "Last 3", tagBg: "#456F94", tagFg: "#fff", category: "Knitwear" },
  ...
  { slug: "ripstop-cargo", image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=900&q=75&auto=format&fit=crop", brand: "nomad", name: "Ripstop Cargo", price: 139, tag: "New", tagBg: "#121212", tagFg: "#fff", category: "Trousers" },
  ...
  { slug: "felted-cardigan", image: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=900&q=75&auto=format&fit=crop", brand: "core-theory", name: "Felted Cardigan", price: 232, tag: "20% off", tagBg: "#DBE1EF", tagFg: "#1A1A1A", category: "Knitwear" },
...
export const LOOKBOOKS: Lookbook[] = [
  { slug: "off-the-shipyard", brand: "form-and-void", title: "Off the shipyard.", season: "Autumn 26", bg: "#C7DCEF", blurb: "Eleven looks shot across two cold mornings in the Rotterdam docks. Nine pieces are shoppable — tap any numbered dot.",
    frames: [
      { image: "https://images.unsplash.com/photo-1611312449408-fcece27cdbb7?w=900&q=75&auto=format&fit=crop", label: "Look 01 · full length", h: 520, product: "panel-work-jacket", x: 38, y: 34 }, { image: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=900&q=75&auto=format&fit=crop", label: "Look 02 · detail", h: 340, bg: "#C7DCEF", product: "corozo-overshirt", x: 62, y: 48 },
      { image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=900&q=75&auto=format&fit=crop", label: "Look 03 · wide", h: 400, product: "wide-wool-trouser", x: 28, y: 60 }, { image: "https://images.unsplash.com/photo-1571945153237-4929e783af4a?w=900&q=75&auto=format&fit=crop", label: "Look 04 · portrait", h: 460, bg: "#1C3247", product: "duck-canvas-cap", x: 50, y: 40 },
      { image: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=900&q=75&auto=format&fit=crop", label: "Look 05 · full length", h: 560, product: "yoke-back-shirt", x: 42, y: 52 }, { image: "https://images.unsplash.com/photo-1479064555552-3ef4979f8908?w=900&q=75&auto=format&fit=crop", label: "Look 06 · still life", h: 300, bg: "#DBE1EF", product: "waxed-tote", x: 70, y: 36 },
    ] },
  { slug: "salt-and-static", brand: "onda-studio", title: "Salt and static", season: "Summer 26", bg: "#1C3247", blurb: "Eight looks on the Porto seawall at 6am.",
    frames: [{ image: "https://images.unsplash.com/photo-1543076447-215ad9ba6923?w=900&q=75&auto=format&fit=crop", label: "Look 01", h: 480, product: "sail-overshirt", x: 45, y: 40 }, { image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=900&q=75&auto=format&fit=crop", label: "Look 02", h: 360, bg: "#C7DCEF", product: "salt-wash-tee", x: 55, y: 50 }, { image: "https://images.unsplash.com/photo-1554568218-0f1715e72254?w=900&q=75&auto=format&fit=crop", label: "Look 03", h: 420 }, { image: "https://images.unsplash.com/photo-1495105787522-5334e3ffa0ef?w=900&q=75&auto=format&fit=crop", label: "Look 04", h: 300, bg: "#DBE1EF" }] },
